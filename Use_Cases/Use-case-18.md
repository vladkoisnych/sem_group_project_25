Goal in context: produce a report for an organisation.

Scope: The system will run an SQL report on the database.

Level: Produce a list off a countries in a continent of size given by the user in order of the largest population to the smallest.
...
Schedule: The use case should be delivered by 29/10/2024